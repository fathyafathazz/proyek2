...
@section('main')
    <div class="col-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title mb-4">Tambah data Jenis Kos</h4>
                @if ($errors->any())
                ...
                @endif
                <form class="forms-sample" method="POST" action="/tambahjeniskos" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
                        ...
                        <label for="nama_jenis_kos">Nama Jenis Kos</label>
                        <input type="text" class="form-control" id="nama_jenis_kos"
                            placeholder="Single/Berdua/Keluarga" name="nama_jenis_kos" required>
                    </div>
                    <button type="submit" class="btn btn-primary me-2">Tambah</button>
                    <a href="/jenis_kos" class="btn btn-light">Kembali</a>
                </form>
            </div>
        </div>
    </div>
