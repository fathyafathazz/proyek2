...
@section('main')
    <div class="col-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title mb-4">Edit data Jenis Kos</h4>
                @if ($errors->any())
                ...
                @endif
                <form class="forms-sample" method="POST" action="/editjeniskos">
                    @csrf
                    <input type="hidden" name="id" value="{{ $data->id }}">
                    <div class="form-group">
                        <label for="nama_jenis_kos">Nama Jenis Kos</label>
                        <input type="text" class="form-control" id="nama_jenis_kos" name="nama_jenis_kos" required>
                    </div>
