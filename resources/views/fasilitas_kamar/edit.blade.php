    ...
    <div class="col-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                @endif
                <form class="forms-sample" method="POST" action="/editfasilitaskamar">
                    @csrf
                    <input type="hidden" name="id" value="{{ $data->id }}">
                    <div class="form-group">
                        <label for="nama_fasilitas_kamar">Nama Fasilitas Kamar</label>
                        <input type="text" class="form-control" id="nama_fasilitas_kamar" name="nama_fasilitas_kamar"
                            value="{{ $data->nama_fasilitas_kamar }}" required>
                    </div>
