...
@section('main')
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/css/all.min.css"
        integrity="sha512-lgFzCCWAqwP5pxJcOBOZVex9KOTu5zplz3F/J2xJ7R1Hg7Iep5ZMgNSYbIvMKRD / nURJgzI/1qLMp9F0N/hYS0A=="
                                    ...
                                    {{-- <div class="col">
                                        <div class="progress progress-sm mr-2">
                                            <div class="progress-bar bg-info" role="progressbar"
                                                style="width: {{ ($jumlahPemilikKos / $totalUsers) * 100 }}%"
                                                aria-valuenow="{{ ($jumlahPemilikKos / $totalUsers) * 100 }}"
