            ...
            <div class="wrap-login100">
                <form action="{{ route('registrasi') }}" class="login100-form validate-form"method="POST"
                    ...
                    <div style="margin : 20px 20px 40px 20px;">
                        <label for="gambar" style="margin-bottom: 10px; font-size: 16pt, color:#666666">Foto</label>
                    ...
                    <div class="text-center p-t-46 p-b-20">
                        <span class="txt2">
                            Sudah Punya Akun? <a href="{{ route('auth') }}" class="text-primary">Masuk</a>
                        </span>
                    </div>
