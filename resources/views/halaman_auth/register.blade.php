...
<html lang="en">
<head>
	<title>Sign Up - KosConnect</title>
	<meta charset="UTF-8">
...
@endif
					...
					<div style="margin : 20px 20px 40px 20px;">
						<label for="gambar" style="margin-bottom: 10px; font-size: 16pt, color:#666666">Image</label>
					...
					<div class="text-center p-t-46 p-b-20">
						<span class="txt2">
							Account Already? <a href="{{route('auth')}}" class="text-primary">Sign In</a>
						</span>
					</div>
