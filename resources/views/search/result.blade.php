...
<h4 class="mt-5">Hasil Pencarian</h4>
    <div class="content mt-3 d-flex flex-lg-wrap gap-5 mb-5">
        ...
        <div class="card" style="width:320px;">
            ...
            <div class="card-header" style="height:100%;width:100%;"><a
                    href="{{ route('user.detail', ['id' => $kamarKos->kos->id]) }}">
                    <img src="{{ asset('public/kamar_kos/' . $kamarKos->gambar) }}" alt="kamar kos"
            ...
            <div class="card-footer d-flex flex-row justify-content-between align-items-center">
                <p class="m-0" style="font-size: 16px; font-weight:600; color:#314051 "><span>Rp
                    ...
                    </span><a href="{{ route('user.detail', ['id' => $kamarKos->kos->id]) }}">{{ number_format($kamarKos->harga_sewa) }} </a></p>
