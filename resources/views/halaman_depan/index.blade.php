    ...
    <body id="page-top">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto">
                        <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded" href="#contact"><i class="fa-solid fa-inbox me-1"></i>Kontak</a></li>
                        <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded" href="{{route('auth')}}"><i class="fa-solid fa-right-to-bracket me-1"></i>Masuk</a></li>
                    </ul>
                </div>
            </div>
        </nav>
        ...
        <header class="masthead bg-primary text-white text-center">
            <div class="container d-flex align-items-center flex-column">
                ...
                <!-- Masthead Heading-->
                <h1 class="masthead-heading text-uppercase mb-0">KosConnect</h1>
                <!-- Icon Divider-->
                ...
                <!-- Masthead Subheading-->
                <p class="masthead-subheading font-weight-light mb-0">Temukan Kosan Ternyamanmu</p>
            </div>
        </header>
        <!-- Contact Section-->
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        ...
                        <p class="lead mb-0">
                            KosConnect adalah tempat untuk menemukan kos yang sesuai dengan preferensi calon penyewa, website ini dibuat oleh tim
                            <a href="http://startbootstrap.com">KosConnect</a>
                            .
                        </p>
                    </div>
                </div>
