...
@section('main')
    <div class="col-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title mb-4">Tambah data Fasilitas Kos</h4>
                @if ($errors->any())
                ...
                @endif
                <form class="forms-sample" method="POST" action="/tambahfasilitas" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
                        ...
                        <label for="nama_fasilitas">Nama Fasilitas Kos</label>
                        <input type="text" class="form-control" id="nama_fasilitas"
                            placeholder="Kamar Mandi Luar" name="nama_fasilitas" required>
                    </div>
                    <button type="submit" class="btn btn-primary me-2">Tambah</button>
                    <a href="/fasilitas" class="btn btn-light">Kembali</a>
                </form>
            </div>
        </div>
    </div>
