                ...
                <form class="forms-sample" method="POST" action="/editkamarkos" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <select class="select2 form-control" id="id_kos" name="id_kos" required>
                            <option value="{{ $data->kos->id_kos }}" selected>{{ $data->kos->nama_kos }}</option>
                            @foreach ($kos as $kos)
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-check">
                            @foreach ($data->fasilitasCustom as $fasilitas)
                                ...
                                <label class="form-check-label" for="fasilitas_custom_{{ $fasilitas->id }}">{{ $fasilitas->nama }} - {{ $formatHelper->formatRupiah($fasilitas->harga) }}</label><br>
                            @endforeach
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="jumlah_kamar_tersedia"
                            name="jumlah_kamar_tersedia" value="{{ $data->jumlah_kamar_tersedia }}" required>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="p-2">
                            @foreach ($data->gambarKamar as $gambar)
                                <img src="{{ asset('public/kamar_kos') }}/{{ $gambar->gambar }}" alt="Image"
                    ...
                    <div class="mb-3">
                        ...
                        <div class="p-2">
                            @if ($data->gambar)
                                @foreach (explode(',', $data->gambar) as $gambar)
                                    <img src="{{ asset('public/kamar_kos/' . $gambar) }}" alt="Image"
